...
#SBATCH --time=60:00
#SBATCH --output=/users/ccocha/FIO/fio-tests/randread/128_node/%j.log
#SBATCH --error=/users/ccocha/FIO/fio-tests/randread/128_node/%j.err


# general settings
fio_njob=64
fio_directory=/scratch/snx2000/ccocha/randread/128_node
LOGSDIR_TOP=/users/ccocha/FIO/fio-tests/randread/128_node
